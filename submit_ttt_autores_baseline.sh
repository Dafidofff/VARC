...
# Autoresearch experiment #1 — BASELINE: unfrozen lr1e3_const on BlockDiag p=2.
# This is the real full-scale SOTA recipe (36.25% Pass@1 on 400, job 269797).
# NOTE: --freeze-hyena-filters is deliberately NOT used — its +18pp on the old
# 50-task subset was an artifact that vanished at full 400 (36.00%, job 277241).
...
EVAL_SAVE_NAME="ttt_autores/baseline"
STRIDE=25

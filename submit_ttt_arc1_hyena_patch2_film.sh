...
#SBATCH --job-name=varc_ttt_hyena_p2_film
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=3-00:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/varc_ttt_hyena_patch2_film_%A_%a.out
#SBATCH --array=0-39

echo "TTT ARC-1 Hyena patch2 FiLM array job ${SLURM_ARRAY_TASK_ID}/39 on node: $SLURM_NODELIST"
echo "Start: $(date)"
...
HYENA_CONFIG="/home/dwessel/code/nvSubquadratic-private/examples/arc/cfg_hyena_rearc_subq_ops_patch2_circular_adaln_film.py"

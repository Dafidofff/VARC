...
#SBATCH --job-name=varc_ttt_hyena_p2_blkd_freeze
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --time=7-00:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/varc_ttt_hyena_patch2_blockdiag_freeze_%A_%a.out
#SBATCH --array=0-39

echo "TTT ARC-1 Hyena patch2 BlockDiag freeze-filters array job ${SLURM_ARRAY_TASK_ID}/39 on node: $SLURM_NODELIST"
echo "Start: $(date)"
...
EVAL_SAVE_NAME="ARC_1_eval_Hyena_patch2_blockdiag_freeze_attempt_0"

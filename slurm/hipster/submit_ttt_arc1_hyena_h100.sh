...
#SBATCH --job-name=varc_ttt_hyena
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --time=3-00:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/varc_ttt_hyena_%A_%a.out
#SBATCH --array=0-7

echo "TTT ARC-1 Hyena array job ${SLURM_ARRAY_TASK_ID}/7 on node: $SLURM_NODELIST"
echo "Start: $(date)"
...
EVAL_SAVE_NAME="ARC_1_eval_Hyena_lr1e3_attempt_0"

# STRIDE is the array size (8 jobs); each job takes tasks at positions
# SLURM_ARRAY_TASK_ID, SLURM_ARRAY_TASK_ID+8, SLURM_ARRAY_TASK_ID+16, ...
STRIDE=8

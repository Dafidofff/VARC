...
#SBATCH --job-name=varc_ttt_hyena_lr1e3_const
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --time=7-00:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/varc_ttt_hyena_lr1e3_const_%A_%a.out
#SBATCH --array=0-39

echo "TTT ARC-1 Hyena lr1e3_const array job ${SLURM_ARRAY_TASK_ID}/39 on node: $SLURM_NODELIST"
echo "Start: $(date)"
...
EVAL_SAVE_NAME="ARC_1_eval_Hyena_lr1e3_const_attempt_0"

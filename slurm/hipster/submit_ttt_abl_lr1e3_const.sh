...
#SBATCH --job-name=ttt_abl_lr1e3_const
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --time=0-04:00:00
#SBATCH --mem=64G
#SBATCH --output=logs/ttt_abl_lr1e3_const_%A_%a.out
#SBATCH --array=0-7

echo "TTT ablation lr1e3_const array ${SLURM_ARRAY_TASK_ID}/7 on ${SLURM_NODELIST}"
echo "Start: $(date)"
set -eo pipefail
...
EVAL_SAVE_NAME="ttt_ablation/lr1e3_const"
STRIDE=8

...
# Full-400 TTT for Hybrid HHAA — non-LoRA baseline.
# Recipe: full fine-tuning of all parameters, lr1e3_const.
# Output dir: ttt_autores/film_hhaa_nolora

echo "TTT hybrid HHAA no-LoRA 400 array ${SLURM_ARRAY_TASK_ID}/39 on ${SLURM_NODELIST}"
echo "Start: $(date)"
set -eo pipefail
...
EVAL_SAVE_NAME="ttt_autores/film_hhaa_nolora"
STRIDE=40

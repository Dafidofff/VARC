...
#SBATCH --job-name=varc_hyena_patch2
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=256
#SBATCH --time=3-00:00:00
#SBATCH --mem=256G
#SBATCH --output=logs/varc_hyena_patch2_%A.out
...
# 8× RTX 6000 Ada (48 GB each). Effective batch size: 8 GPUs × 32 batch × 1 grad-accum = 256.
